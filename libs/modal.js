...
// MODAL CONTROLLER
// =============================================================================
const forextension = 'advanced-dynamic-audio'
const modalmap = new Map()
let modalContainer = $(`#modal-container[for-extension="${forextension}"]`)
if (modalContainer.length === 0) {
    console.log('Modal container does not exist, creating it')
    // prepend the modal container to the body
    $('body').prepend(`<div id="modal-container" for-extension="${forextension}"></div>`)
    modalContainer = $(`#modal-container[for-extension="${forextension}"]`)
}
    ...
    <div class="modal-wrapper">
        <div class="modal ${settings && settings.class || ""}" id="${id}-${randomid}" tabindex="-1" style="${settings && settings.style ? settings.style : ''}">
            <div class="header">
                ...
                ${ settings && settings.showclosebutton ? ` <div class="close">
